...
driver.find_element(by=By.ID, value="ui-datepicker-div").find_element(by=By.XPATH, value="//table/tbody/tr/td/a[text()='4']").click()

time.sleep(2)

result = driver.find_element(by=By.ID, value="theme_ac_279").find_elements(by=By.XPATH, value="//div[2]/div/a/p[1]").copy()
